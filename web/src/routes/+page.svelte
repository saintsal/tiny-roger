			...
			<div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-screen-xl lg:px-8">
				<div class="lg:grid lg:grid-cols-3 lg:gap-8">
					...
					<Feature title="Great Dev experience">
						<a class="text-blue-600" href="https://hardhat.org" target="_blank" rel="noopener"
							>Hardhat</a
						>
						for contracts,
						<a
						...
						<a class="text-blue-600" href="https://thegraph.com" target="_blank" rel="noopener"
							>The Graph</a
						>
						for contract api,
						<a class="text-blue-600" href="https://svelte.dev" target="_blank" rel="noopener"
							>svelte + Svelte Kit</a
						>
					...
					<Feature title="All in Typescript"
						>The whole app including contracts tests, is written in typescript.</Feature
					>
